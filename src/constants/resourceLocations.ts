...
export const WINDOWTINTBG_JPG = "/windowtintbg.jpg";
export const EXTERIORBG_JPG = "/exteriorbg.jpg";
...
export const TINT_PRICE_JPG = "/tintprice.jpg";
export const TINT_PRICE_SM_JPG = "/tintpricesm.jpg";
